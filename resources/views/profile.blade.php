                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @foreach($seeker as $sek)
                            ...
                            @if($customer->id == $sek->job_id and $sek->user_id == $ss->id)
                               <h5 style="text-align: center">  <strong>{{$customer->name}}</strong>
                                @if($customer->id == $sek->job_id and $sek->user_id == $ss->id and $sek->select==1)
                                      <p style="color: green">(Selected For Interview)</p></h5>
                                    @endif
