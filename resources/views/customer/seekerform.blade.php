...
{{--    {{$customer->id}}--}}
    ...
    <div style="color:#331b4b" class="form-outline mb-4">
        <label for="job_id"><i><strong>Job ID :</strong></i></label>
        <input type="text" name="job_id" value="{{$customer->id}}" class="form-control; border border-info">
        <div>{{$errors->first('job_id')}}</div>
    </div>
