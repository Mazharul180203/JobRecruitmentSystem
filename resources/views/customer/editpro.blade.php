...
{{--            <input type="text" name="Nat" value="{{old('Nat')}}" class="form-control; border border-info">--}}
            <label for="Nat"><i><strong>Nationality :</strong></i></label>
            <select style="background-color:powderblue" name="Nat" id="Nat" class="form-control">
...
{{--            <input type="text" name="d_b" value="{{old('d_b')}}" class="form-control; border border-info">--}}
            <label for="d_b"><strong>Date Of Birth :</strong></label>

            <input type="date" id="d_b" name="d_b"
                   value="1990-01-01"
...
{{--            <div>{{$errors->first('gender')}}</div>--}}
            <label for="gender"><i><strong>Gender :</strong></i></label>
            <select style="background-color:powderblue" name="gender" id="gender" class="form-control">
                <option style="background-color: whitesmoke" value="">Select Gender</option>
                <option  style="background-color: whitesmoke" value="Male"> Male</option>
                <option style="background-color: whitesmoke" value="Female"> Female</option>
                <option style="background-color: whitesmoke" value="Others"> Others</option>
            </select>
