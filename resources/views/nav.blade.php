    ...
    <div class="container">
        ...
        <nav class="navbar navbar-light navbar-expand-md fixed-top border-dark border rounded shadow-lg d-inline-flex"
            ...
            <div class="container-fluid">
                ...
                <a class="navbar-brand text-white" href="/home">Job Recruitment System</a>
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        @if (Route::has('login'))
                            @auth
                                ...
                                @if(\Illuminate\Support\Facades\Auth::user()['email']=='mazhar1803@cseku.ac.bd' and \Illuminate\Support\Facades\Auth::user()['role']=='Admin')
                                    <li class="nav-item" role="presentation" data-bs-hover-animate="pulse">
                                        <a class="nav-link active text-white" href="/admin">Admin</a>
                                    </li>
                                @elseif(\Illuminate\Support\Facades\Auth::user()['email']!='mazhar1803@cseku.ac.bd' and \Illuminate\Support\Facades\Auth::user()['role']=='Admin')
                                    <li class="nav-item" role="presentation" data-bs-hover-animate="pulse">
                                ...
                                @elseif (\Illuminate\Support\Facades\Auth::user()['role']=='Recruiter' and \Illuminate\Support\Facades\Auth::user()['select']=='1')
                                    ...
                                    <li class="nav-item" role="presentation">
                                         <a  class="nav-link text-white" data-bs-hover-animate="pulse" href="/profile"><i class="fa fa-user-circle-o fa-2x" aria-hidden="true"></i></a>
                                    </li>
